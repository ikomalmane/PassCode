...
public class AddNewPCodeActivity extends AppCompatActivity {
    ...
    protected Dialog onCreateDialog(int id) {
       ...
       private void checkPass(){
          final String pass= edText_Passcode.getText().toString();
           final String passRe= edText_Passcode.getText().toString();

           edText_Re_Pass.addTextChangedListener(new TextWatcher() {
               @Override
               ...
               public void afterTextChanged(Editable s) {
                   if (pass==passRe) {
                       ...
                       Toast.makeText(AddNewPCodeActivity.this, "PLZ RE ENTER PASSCODE", Toast.LENGTH_SHORT).show();
                       edText_Re_Pass.setText("");
                   }
               }
           });
